    ...
    <div className="min-h-screen bg-[#F1F5F9] font-sans">
      <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col gap-5">
        ...
        <div className="grid grid-cols-12 gap-6" style={{ minHeight: 'calc(100vh - 100px)' }}>
          ...
          {/* ── 좌측: 오늘 (col-span-5) ── */}
          <div className="col-span-5 bg-[#0F1E36] rounded-3xl p-7 flex flex-col overflow-hidden">
          ...
          <div className="col-span-7 grid grid-cols-2 gap-5">
            ...
            {/* 내일 */}
            <div className="bg-white rounded-3xl p-6 flex flex-col gap-4 shadow-[0_4px_24px_rgba(0,0,0,0.06)] overflow-hidden">
